## ----,eval=F,message=FALSE,warning=FALSE,fig.width = 6, fig.height = 6,cache=TRUE----
...
## ----,eval=T,message=FALSE,warning=FALSE,fig.width = 6, fig.height = 6,cache=TRUE----
library(maptools)
library(raster)
...
## ----,eval=T,message=FALSE,warning=FALSE,fig.width = 8, fig.height = 8,cache=TRUE----
